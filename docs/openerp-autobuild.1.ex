...
.TH OPENERP "1" "November 2013" "OpenERP Autobuild 2.1" "User Commands"
.SH NAME
OpenERP \- manual page for OpenERP Autobuild 2.1
.SH DESCRIPTION
usage: openerp_autobuild.py [\-h] [\-v] GOAL ...
.PP
...
.SH COPYRIGHT
Copyright \(co 2012\-2013 Bluestar Solutions S??rl (<http://www.blues2.ch>).
