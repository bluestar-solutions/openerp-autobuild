...
USER_CONFIG_PATH = '%s/.config' % HOME
OEBUILD_CONFIG_PATH = '%s/openerp-autobuild' % CONFIG_PATH
OEBUILD_CONFIG_FILE = '%s/oebuild_config.py' % CONFIG_FILE_PATH
OPENERP_CONFIG_FILE = '%s/.openerp-dev-default' % os.getcwd()
